...
$servers->setValue('server','name','Chiba: LDAP server for home.lan');
...
$servers->setValue('server','base',array('dc=home,dc=lan'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=home,dc=lan');
